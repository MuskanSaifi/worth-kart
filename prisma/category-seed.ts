...
export const CATEGORY_TREE: SeedCategory[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { name: "Laptops", slug: "electronics-laptops-laptops", keywords: "laptop notebook computer dell hp lenovo" },
          { name: "Gaming Laptops", slug: "electronics-laptops-gaming", keywords: "gaming laptop rtx graphic card" },
          { name: "Computer Accessories", slug: "electronics-laptops-accessories", keywords: "keyboard mouse monitor webcam pendrive" },
        ],
      },
      {
        name: "Wearables",
        ...
        children: [
          { name: "Smartwatches", slug: "electronics-wearables-smartwatches", keywords: "smartwatch watch fitness apple boat noise" },
          { name: "Fitness Bands", slug: "electronics-wearables-fitness-bands", keywords: "fitness band mi band activity tracker" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          { name: "LED TVs", slug: "tvs-appliances-led-tvs", keywords: "led tv television 32 inch 43 inch" },
          { name: "Smart TVs", slug: "tvs-appliances-smart-tvs", keywords: "smart tv android tv fire tv" },
        ],
      },
      {
        ...
        children: [
          { name: "Washing Machines", slug: "tvs-appliances-washing-machines", keywords: "washing machine washer semi automatic front load" },
          { name: "Refrigerators", slug: "tvs-appliances-refrigerators", keywords: "fridge refrigerator double door single door" },
          { name: "Air Conditioners", slug: "tvs-appliances-ac", keywords: "ac air conditioner split inverter 1 ton" },
          { name: "Mixer Grinders", slug: "tvs-appliances-mixer-grinders", keywords: "mixer grinder juicer blender prestige" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        slug: "fashion-men",
        children: [
          { name: "T-Shirts & Shirts", slug: "fashion-men-tshirts", keywords: "tshirt shirt men polo casual formal" },
          { name: "Jeans & Trousers", slug: "fashion-men-jeans", keywords: "jeans pant trouser men denim" },
          { name: "Shoes", slug: "fashion-men-shoes", keywords: "shoes men sneaker formal sports sandal" },
        ],
      },
      {
        name: "Women",
    ...
    children: [
      {
        ...
        slug: "beauty-makeup",
        children: [
          { name: "Lipstick", slug: "beauty-makeup-lipstick", keywords: "lipstick lip color matte liquid" },
          { name: "Face Makeup", slug: "beauty-makeup-face", keywords: "foundation compact blush primer concealer" },
        ],
      },
      {
        name: "Skin Care",
        ...
        children: [
          { name: "Moisturizers", slug: "beauty-skincare-moisturizers", keywords: "moisturizer cream face lotion hydrating" },
          { name: "Sunscreen", slug: "beauty-skincare-sunscreen", keywords: "sunscreen spf sun protection lotion" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          { name: "Sofas & Seating", slug: "home-furniture-sofas", keywords: "sofa couch seating living room" },
          { name: "Beds & Wardrobes", slug: "home-furniture-beds", keywords: "bed wardrobe almirah mattress bedroom" },
        ],
      },
      {
        name: "Home Decor",
        ...
        children: [
          { name: "Wall Decor", slug: "home-furniture-wall-decor", keywords: "wall decor painting frame clock sticker" },
          { name: "Lighting", slug: "home-furniture-lighting", keywords: "lamp light bulb led chandelier" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        children: [
          { name: "Rice & Flour", slug: "grocery-staples-rice", keywords: "rice atta flour basmati wheat daliya" },
          { name: "Pulses", slug: "grocery-staples-pulses", keywords: "dal pulse moong chana masoor toor" },
        ],
      },
    ],
  },
